...
{
    Task<Result<Week>> CreateNewWeekAsync(Guid userId, DateTime startDate, DateTime endDate, CancellationToken ct = default);
    Task<Result<Week>> CreateNewWeekForTeamAsync(Guid teamId, Guid? creatorId, DateTime startDate, DateTime endDate, CancellationToken ct = default);
