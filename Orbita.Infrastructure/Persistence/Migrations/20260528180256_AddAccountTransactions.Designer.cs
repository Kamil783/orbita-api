...
namespace Orbita.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260528180256_AddAccountTransactions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orbita.Infrastructure.Entities.AccountEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TeamId", "CurrencyCode");

                    b.ToTable("Accounts");
                });

            modelBuilder.Entity("Orbita.Infrastructure.Entities.AccountTransactionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orbita.Infrastructure.Entities.CurrencyEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("RateFetchedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Orbita.Infrastructure.Entities.RecurringTaskEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Orbita.Infrastructure.Entities.AccountEntity", b =>
                {
                    b.HasOne("Orbita.Infrastructure.Entities.CurrencyEntity", "Currency")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("Orbita.Infrastructure.Entities.AccountTransactionEntity", b =>
                {
                    b.HasOne("Orbita.Infrastructure.Entities.AccountEntity", "Account")
                        .WithMany()
